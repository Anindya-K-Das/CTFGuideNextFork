  ...
  return (
    <>
      ...
      >
        ...
        <img src="https://preview.ctfguide.com/darkLogo.png" alt="CTFGuide Logo" width={100} className='mx-auto' />
        ...
        <h1 className='text-white text-3xl font-semibold'>Platform Maintenance</h1>
          ...
          <br></br>
          <a href="https://discord.gg/bH6gu3HCFF" className='bg-blue-600 text-white px-10 py-2 rounded-lg'>Join the Discord</a>
